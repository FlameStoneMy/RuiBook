package com.ruitech.bookstudy.decoration;
...
public class GridEntrust extends SpacesItemDecorationEntrust {
    ...
    private static final String TAG = "GridEntrust";
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        android.util.Log.d(TAG, "getItemOffsets outRect: " + childPosition + " " + outRect);
    }
