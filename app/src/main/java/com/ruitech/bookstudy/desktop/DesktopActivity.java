...
import com.ruitech.bookstudy.EyeProtectEvent;
...
public class DesktopActivity extends BaseActivity implements CategoryListLoadTask.Callback,
...
//        RuiPreferenceUtil.setGrade(Grade.FIFTH_GRADE);
//        RuiPreferenceUtil.setNickname("amao");
        ...
        recyclerView.addItemDecoration(new SpacesItemDecoration(UIHelper.dp2px(20), UIHelper.dp2px(20)));
//        recyclerView.addItemDecoration(DecorationFactory.get30_30_30_30Space0_0_0_0());
        ...
        try {
            ...
            if (pkgInfo != null) {
                ((TextView) findViewById(R.id.version_tv)).setText("v" + pkgInfo.versionName);
            }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.eye_protect:
                App.toggleEyeProtect();
                EventBus.getDefault().post(new EyeProtectEvent());
...
//    }
    ...
    public void onNewVersion(UpgradeBean upgradeBean) {
        ...
        android.util.Log.d(TAG, "onNewVersion: " + upgradeBean.versionCode);
    }
